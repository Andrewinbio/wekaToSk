...
def main_classification(path, f_list, agg=1, rank=False, ens_for_rank=''):
    ...
    """ Stacking Ensemble """
    stackers_dict = {
        "CF.S1": cf_stacker(base_estimator=LogisticRegression(),
                           latent_dimension=5,
                           threshold=0.5,
                           alpha_nmf=0.05,
                           max_iter_nmf=500,
                           ...
                           nmf=True,
                           return_probs=True),
        "CF.S2": cf_stacker(base_estimator=LogisticRegression(),
                           latent_dimension=5,
                           threshold=0.5,
                           alpha_nmf=1,
                           max_iter_nmf=500,
                           ...
                           nmf=True,
                           return_probs=True),
        "CF.S3": cf_stacker(base_estimator=LogisticRegression(),
                           latent_dimension=5,
                           threshold=0.5,
                           alpha_nmf=0.5,
                           max_iter_nmf=500,
