...
def main_classification(path, f_list, agg=1, rank=False, ens_for_rank=''):
    ...
    """ Stacking Ensemble """
    stackers_dict = {
        "CF.S-without-NMF": cf_stacker(base_estimator=SVR(max_iter=100),
                           latent_dimension=5,
                           threshold=0.5,
                           alpha_nmf=1,
                           max_iter_nmf=500,
                           ...
                           return_probs=True,
                           method="median"),
        "CF.S-LR": cf_stacker(base_estimator=SVR(max_iter=100),
                           latent_dimension=5,
                           threshold=0.5,
                           alpha_nmf=1,
                           max_iter_nmf=2000,
                           ...
                           return_probs=True,
                           method="median"),
        "CF.S-LR2": cf_stacker(base_estimator=SVR(max_iter=100),
                              latent_dimension=5,
                              threshold=0.5,
                              alpha_nmf=1,
                              max_iter_nmf=2000,
