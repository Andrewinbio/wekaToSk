...
from sklearn.linear_model import LogisticRegression, LinearRegression, Ridge  # LR
...
from cf_stacker5 import MatrixFactorizationClassifier
...
def main_classification(path, f_list, agg=1, rank=False, ens_for_rank=''):
    ...
    """ Stacking Ensemble """
    stackers_dict = {
        "CF.S-NMF1": MatrixFactorizationClassifier(latent_dim=15,
                                                   alpha=0.9,
                                                   max_iter=600,
                                                   learning_rate=0.01,
                                                   tol=0.0000000001,
        ...
        #                                            lam=0.02,
        #                                            method="mean"),
        # "CF.S-NMF3": MatrixFactorizationClassifier(latent_dim=10,
        #                                            max_iter=500,
        #                                            learning_rate=0.001,
        #                                            tol=0.01,
        #                                            lam=0.04,
        #                                            method="mean"),
        # "CF.S-NMF4": MatrixFactorizationClassifier(latent_dim=10,
        #                                            max_iter=500,
        #                                            learning_rate=0.001,
        #                                            tol=0.01,
        #                                            lam=0.06,
        #                                            method="mean"),
        # "CF.S-NMF5": MatrixFactorizationClassifier(latent_dim=10,
        #                                            max_iter=500,
        #                                            learning_rate=0.001,
        #                                            tol=0.01,
        #                                            lam=0.08,
        #                                            method="mean"),
        # "CF.S-NMF6": MatrixFactorizationClassifier(latent_dim=10,
        #                                            max_iter=500,
        #                                            learning_rate=0.001,
        #                                            tol=0.01,
        #                                            lam=0.1,
