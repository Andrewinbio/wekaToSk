...
def main_classification(path, f_list, agg=1, rank=False, ens_for_rank=''):
    ...
    stackers_dict = {
        ...
        "CF.S-NMF1": CFStacker(base_estimator=LinearRegression(),
                               ...
                               return_probs=True,
                               method="lr"),
        # "CF.S-NMF2": CFStacker(base_estimator=LinearRegression(),
        #                        latent_dimension=10,
        #                        threshold=0.08,
        #                        alpha_nmf=0.0,
        #                        max_iter_nmf=50,
        ...
        #                        return_probs=True,
        #                        method="mean"),
        # "CF.S-NMF3": CFStacker(base_estimator=LinearRegression(),
        #                        latent_dimension=30,
        #                        threshold=0.08,
        #                        alpha_nmf=0.0,
        #                        max_iter_nmf=50,
        ...
        #                        return_probs=True,
        #                        method="mean"),
        # "CF.S-NMF4": CFStacker(base_estimator=LinearRegression(),
        #                        latent_dimension=40,
        #                        threshold=0.08,
        #                        alpha_nmf=0.0,
        #                        max_iter_nmf=500,
        ...
        #                        return_probs=True,
        #                        method="mean"),
        # "CF.S-NMF5": CFStacker(base_estimator=LinearRegression(),
        #                        latent_dimension=50,
        #                        threshold=0.08,
        #                        alpha_nmf=0.0,
        #                        max_iter_nmf=500,
