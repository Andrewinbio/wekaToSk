...
def main_classification(path, f_list, agg=1, rank=False, ens_for_rank=''):
    ...
    stackers_dict = {
        ...
        "CF.S-LR": cf_stacker(base_estimator=LinearRegression(),
                           ...
                           return_probs=True,
                           method="median"),
        "CF.S-LR2": cf_stacker(base_estimator=LinearRegression(),
                              latent_dimension=4,
                              threshold=0.5,
                              alpha_nmf=1,
                              max_iter_nmf=500,
                              ...
                              return_probs=True,
                              method="median"),
        "CF.S-LR3": cf_stacker(base_estimator=LinearRegression(),
                               latent_dimension=4,
                               threshold=0.5,
                               alpha_nmf=1,
                               max_iter_nmf=500,
                               ...
                               return_probs=True,
                               method="median"),
        "CF.S-LR4": cf_stacker(base_estimator=LinearRegression(),
                               latent_dimension=4,
                               threshold=0.5,
                               alpha_nmf=1,
                               max_iter_nmf=500,
                               ...
                               return_probs=True,
                               method="median"),
        "CF.S-LR5": cf_stacker(base_estimator=LinearRegression(),
                               latent_dimension=4,
                               threshold=0.5,
                               alpha_nmf=1,
                               max_iter_nmf=500,
        ...
        #                       return_probs=True,
        #                       method="median"),
        # "CF.S-SVM": cf_stacker(base_estimator=SVR(),
        #                    latent_dimension=5,
        #                    threshold=0.65,
        #                    alpha_nmf=1,
        #                    max_iter_nmf=500,
