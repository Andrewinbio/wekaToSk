...
def main_classification(path, f_list, agg=1, rank=False, ens_for_rank=''):
    ...
    stackers_dict = {
        "CF.S-NMF1": MatrixFactorizationClassifier(latent_dim=3,
                                                   ...
                                                   lam=0.05,
                                                   method="mean"),
        "CF.S-NMF2": MatrixFactorizationClassifier(latent_dim=3,
                                                   max_iter=100,
                                                   learning_rate=0.001,
                                                   tol=0.000001,
                                                   lam=0.05,
                                                   method="mean"),
        "CF.S-NMF3": MatrixFactorizationClassifier(latent_dim=3,
                                                   max_iter=100,
                                                   learning_rate=0.001,
                                                   tol=0.000001,
                                                   lam=0.05,
                                                   method="mean"),
        "CF.S-NMF4": MatrixFactorizationClassifier(latent_dim=3,
                                                   max_iter=100,
                                                   learning_rate=0.001,
                                                   tol=0.000001,
                                                   lam=0.05,
                                                   method="mean"),
        "CF.S-NMF5": MatrixFactorizationClassifier(latent_dim=3,
                                                   max_iter=100,
                                                   learning_rate=0.001,
                                                   tol=0.000001,
                                                   lam=0.05,
                                                   method="mean"),
        "CF.S-NMF6": MatrixFactorizationClassifier(latent_dim=3,
                                                   max_iter=100,
                                                   learning_rate=0.001,
                                                   tol=0.000001,
                                                   lam=0.05,
