...
def main_classification(path, f_list, agg=1, rank=False, ens_for_rank=''):
    ...
    """ Stacking Ensemble """
    stackers_dict = {
        "CF.S-NMF1": MatrixFactorizationClassifier(latent_dim=8,
                                                   max_iter=5000,
                                                   learning_rate=0.001,
                                                   tol=0.01,
                                                   lam=0.0,
        ...
        "CF.S-NMF2": MatrixFactorizationClassifier(latent_dim=5,
                                                   ...
                                                   lam=0.0,
                                                   method="mean"),
        "CF.S-NMF3": MatrixFactorizationClassifier(latent_dim=5,
                                                   max_iter=100,
                                                   learning_rate=0.001,
                                                   tol=0.000001,
                                                   lam=0.0,
                                                   method="mean"),
        "CF.S-NMF4": MatrixFactorizationClassifier(latent_dim=5,
                                                   max_iter=100,
                                                   learning_rate=0.001,
                                                   tol=0.000001,
                                                   lam=0.0,
                                                   method="mean"),
        "CF.S-NMF5": MatrixFactorizationClassifier(latent_dim=5,
                                                   max_iter=100,
                                                   learning_rate=0.001,
                                                   tol=0.000001,
                                                   lam=0.0,
                                                   method="mean"),
        "CF.S-NMF6": MatrixFactorizationClassifier(latent_dim=5,
                                                   max_iter=100,
                                                   learning_rate=0.001,
                                                   tol=0.000001,
                                                   lam=0.0,
